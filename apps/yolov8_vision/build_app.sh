...
cp -f "${BUILD_DIR}/bin/yolov8_vision.elf" "${BIN_DIR}/"
cp -f "${MODEL_DIR}/yolov8n_320.kmodel" "${BIN_DIR}/models/"
cp -f "${MODEL_DIR}/yolov8n_seg_320.kmodel" "${BIN_DIR}/models/"
echo "[yolov8-vision] package ready: ${BIN_DIR}"
